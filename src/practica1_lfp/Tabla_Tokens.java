...
public class Tabla_Tokens extends javax.swing.JFrame {
    ArrayList<Tokens> listaTokens;
    DefaultTableModel md;
    String Datos [][]={};
    String Titulos [] = {"No", "Descripcion", "lexema", "Id","fila", "columna"};
    
    
    public Tabla_Tokens(ArrayList<Tokens> t) {
        initComponents();
        listaTokens = t;
    ...
    public void Ingresar_Datos(){
        ArrayList<Tokens> Acepatacion = listaTokens;
        ...
        if (listaTokens != null)
        {
            ...
            {
                int no = i+1;
                String descripcion = Acepatacion.get(i).getTipo();
                String lexema = Acepatacion.get(i).getLexema();
                int id = Acepatacion.get(i).getId();
